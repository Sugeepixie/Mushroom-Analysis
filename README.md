...
We were able to rank the importance of the mushroom features in our Random Forest Classifier model. We were able to determine that odor had the highest importance score of over 0.15, followed by gill size and gill color. The importance scores suggests that it is likely the combination of all mushroom features that indicates whether or not it is poisonous, although odor is the best predictor.
